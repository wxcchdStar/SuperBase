...
public class ImagePreviewIndicator extends View {
    ...
    public ImagePreviewIndicator(Context context) {
        super(context);
        init(context, null);
    }

    public ImagePreviewIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ImagePreviewIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ImagePreviewIndicator(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getResources().obtainAttributes(attrs, R.styleable.ImagePreviewIndicator);
        try {
            mSpacing = a.getDimension(R.styleable.ImagePreviewIndicator_spacing, mSpacing);
            mRadius = a.getDimension(R.styleable.ImagePreviewIndicator_radius, mRadius);
            activeColor = a.getColor(R.styleable.ImagePreviewIndicator_activeColor, activeColor);
            inactiveColor = a.getColor(R.styleable.ImagePreviewIndicator_inactiveColor, inactiveColor);
        } finally {
            a.recycle();
        }
